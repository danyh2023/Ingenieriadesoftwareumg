    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="<?php if (isset($active_usuarios)){echo $active_usuarios;}?>"><a href="usuarios.php"><i  class='glyphicon glyphicon-user'></i> Usuarios</a></li>
                <li class="<?php if (isset($active_proveedores)){echo $active_proveedores;}?>"><a href="proveedores.php"><i  class='glyphicon glyphicon-inbox'></i> Proveedores</a></li>
		<li class="<?php if (isset($active_soporte)){echo $active_soporte;}?>"><a href="soporte.html"><i  class='glyphicon glyphicon-flash'></i> Soporte Tecnico</a></li>
		<li class="<?php if (isset($active_contacto)){echo $active_contaco;}?>"><a href="contacto.html"><i  class='glyphicon glyphicon-question-sign'></i> Contacto</a></li>
       </ul>
